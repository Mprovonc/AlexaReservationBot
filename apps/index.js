...
app.launch(function(req, res) {
  ...
  var outputSpeech = "Hi! Welcome to Michaels Resraunt How can I help you today?";
  var outputText = "Hi! Welcome to Michaels Restraunt. How can I help you today?";
  var promptText = "Hi! Welcome to Michaels Restraunt. How can I help you today?";

  //Send response
  res.card({
    type: "Standard",
    title: "Michaels Restraunt",
    text: outputText
  });
