...
botLib.makeReservation = function(reservationObj) {
   ...
   return new Promise(function(resolve, reject) {
      ...
      db.insertRecord("michaels restraunt", insertDataObj, function(errMsg, dbResponse){
...
botLib.cancelReservation = function(reservationNumber) {
   ...
   var tableNameArray = ["michaels restraunt mdr"];
   var selectColArray = ["*"];
   ...
   return new Promise(function(resolve, reject) {
      ...
      db.selectRecord(selectColArray, tableNameArray, whereStr, whereBindArray, orderByStr, null, null, function(err, dbResult){
         ...
         if(err)
            ...
            db.updateRecord("michaels restraunt", setStr, whereStr, function(err, updateResult){
